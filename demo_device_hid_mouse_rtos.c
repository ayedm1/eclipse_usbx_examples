...
#if (UX_DEVICE_CLASS_HID_EVENT_BUFFER_LENGTH < 6)
#error HID mouse event buffer length must be more then 4 in standard mode and 6 in absolute mode.
#endif
...
UINT ux_demo_device_hid_mouse_cursor_move(UX_SLAVE_CLASS_HID *device_hid);
UINT ux_demo_device_hid_mouse_absolute_cursor_move(UX_SLAVE_CLASS_HID *device_hid);
...
#ifdef UX_DEMO_MOUSE_ABSOLUTE
            ux_demo_device_hid_mouse_absolute_cursor_move(hid_mouse);
#else /* UX_DEMO_MOUSE_ABSOLUTE */
            ux_demo_device_hid_mouse_cursor_move(hid_mouse);
#endif /* UX_DEMO_MOUSE_ABSOLUTE */
        }
        else
        {
...
/********************************************************************/
/**  ux_demo_device_hid_mouse_cursor_move:                          */
/**          Move mouse cursor                                      */
/********************************************************************/
UINT ux_demo_device_hid_mouse_cursor_move(UX_SLAVE_CLASS_HID *device_hid)
{
...
/***************************************************************************************/
/**  ux_demo_device_hid_mouse_absolute_cursor_move:                                    */
/**       Daw a rectangle with  width 10000, height 10000, step size 500               */
/***************************************************************************************/
UINT ux_demo_device_hid_mouse_absolute_cursor_move(UX_SLAVE_CLASS_HID *device_hid)
{
